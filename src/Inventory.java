...
public class Inventory extends JDialog {
    ...
    private void initComponents() {
        ...
        lcategory = new JLabel("Category:", JLabel.RIGHT);
        ldescription = new JLabel("Description:", JLabel.RIGHT);
        lPrice = new JLabel("Price:", JLabel.RIGHT);
        lquantity = new JLabel("Quantity:", JLabel.RIGHT);
    ...
    private void doDelete() {
        if (current > 0) {
            try {
                current = rs.getInt(1);
                rs.deleteRow();
                JOptionPane.showMessageDialog(this, "Inventory Object deleted successfully!");
                data2Form();
            } catch (SQLException e) {
    ...
    private JLabel lid, lcategory, ldescription, lquantity, lPrice;
